...
import { EditorialCarouselSectionItem } from '@/components/home/EditorialCarouselSectionItem'
...
> = ({ title, moreLink = '#', items = [], color = 'text-white ' }) => {
  return (
    <div>
      ...
      >
        {items.map((item, index) => (
          <SwiperSlide key={index}>
            <EditorialCarouselSectionItem item={item} />
          </SwiperSlide>
        ))}
      </Swiper>
    </div>
