...
import { SliderVerticalPosts2 } from '@/components/inspirate-en-venezuela/SliderVerticalPosts2'

export default async function Page() {
  const { posts } = await getWpPosts({
    categories: CATEGORIES['destinos-del-mes'].toString(),
    per_page: 20,
  })
